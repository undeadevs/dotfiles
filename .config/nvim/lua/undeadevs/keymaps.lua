...
vim.api.nvim_set_keymap(
  ...
  "\\`",
  "`",
  { silent = true, noremap = true, desc = "Avoid competion when escaping backticks" }
)
vim.api.nvim_set_keymap(
  "i",
  "\\(",
...
vim.api.nvim_set_keymap(
  ...
  "\\[",
  "\\[",
  { silent = true, noremap = true, desc = "Avoid completion when escaping brackets" }
)
vim.api.nvim_set_keymap(
  "i",
  "\\{",
  "\\{",
  { silent = true, noremap = true, desc = "Avoid completion when escaping curlies" }
)
