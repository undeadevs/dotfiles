...
end, { desc = "[1h] Jump to 1st file in harpoon list" })

vim.keymap.set("n", "<leader>2h", function()
  require("harpoon.ui").nav_file(2)
end, { desc = "[2h] Jump to 2nd file in harpoon list" })

vim.keymap.set("n", "<leader>3h", function()
  require("harpoon.ui").nav_file(3)
end, { desc = "[3h] Jump to 3rd file in harpoon list" })

vim.keymap.set("n", "<leader>4h", function()
  require("harpoon.ui").nav_file(4)
end, { desc = "[4h] Jump to 4th file in harpoon list" })
